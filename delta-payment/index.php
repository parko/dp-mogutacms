...
class DeltaPayment{
    ...
    public function __construct() {
        ...
        mgAddShortcode('delta-payment', array(__CLASS__, 'addPaymentForm'));
          ...
          if ( isset($p_id, $o_id) ){
            ...
            mgAddMeta('<script type="text/javascript">
                ...
                $(document).ready( function(){
                    ...
                    if( $("#delta-payment-container").length > 0 ){
                        append_block = $("#delta-payment-container");
                    } else {
    ...
    static function addPaymentForm() {
        return "<div id='delta-payment-container'></div>";
    }
      /**
